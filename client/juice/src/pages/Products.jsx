...
<div>
   ...
   <div className=' mt-20 flex flex-col items-center md:flex-row justify-evenly' >
   <div class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
  <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
    <img class="object-cover" src="https://images.pexels.com/photos/357577/pexels-photo-357577.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="product image" />
  ...
  <div class="mt-4 px-5 pb-5">
    ...
    <p>
      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veniam autem nostrum expedita ...
    </p>
